# -*- coding: utf-8 -*-
"""
render_report.py — 每日盘后全景 渲染脚本 v2（投研日报级排版）
=============================================================
用法：
...
DATA_DIR = r'F:/Projects/AI/MaplePublicArticles/panorama/data'
SITE_BASE = 'https://reports.xiaoyiyi.wang/panorama'
BADGE = 'DAILY PANORAMA · 盘后全景'
TITLE = '每日盘后全景'
HOME = '../index.html'
FOOTER = '数据来源：westock-data 行情 / 证券时报 / 同花顺 / 研报 / 404K 知识库 · 板块雷达 × 市场简报 合并版'
...
def render_one(md_path, html_path, all_dates=None):
    ...
    og_desc = f'{TITLE} {date_str} - A股板块雷达 × 宏观市场简报 合并全景：大盘多空、板块四档分类、宏观归因、持仓映射与纪律检查'
    html = render_article(
